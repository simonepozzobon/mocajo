<template lang="html">
    <div>
        <form-group name="description" title="Descrizione">
            <input type="text" name="description" v-model="shipping.description" class="form-control">
        </form-group>
        <form-group name="default" title="Default">
            <input type="text" name="default" v-model="shipping.default" class="form-control">
        </form-group>
        <form-group name="image" title="Logo">
            <file-input
                ref="logo"
                format="svg"
                @file-loaded="logoLoad"/>
        </form-group>
        <form-group name="logoPreview" title="Anteprima Logo">
            <img :src="shipping.logo" class="img-fluid" v-if="shipping.logo">
            <span class="text-danger" v-else>Nessun Logo Caricato!</span>
        </form-group>
        <form-group name="price" title="Prezzo">
            <input type="text" name="price" v-model="shipping.price" class="form-control">
        </form-group>
        <form-group name="increment" title="Moltiplicatore">
            <input type="text" name="increment" v-model="shipping.increment" class="form-control">
        </form-group>
        <form-group name="timing" title="Tempistiche">
            <input type="text" name="timing" v-model="shipping.timing" class="form-control">
        </form-group>
